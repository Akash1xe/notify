...
export const api = {
  ...
  startFrameAnalysis: (videoId: string) => apiFetch<StartFrameAnalysisResponse>("/api/analysis/start", {
    method: "POST",
  ...
  startTeachingStateAnalysis: (videoId: string) => apiFetch<StartTeachingStateAnalysisResponse>("/api/analysis/states/start", {
    method: "POST",
    body: JSON.stringify({ video_id: videoId }),
  }),
  ...
  startScreenshotCandidateAnalysis: (videoId: string) => apiFetch<StartScreenshotCandidateAnalysisResponse>("/api/analysis/candidates/start", {
    method: "POST",
    body: JSON.stringify({ video_id: videoId }),
  }),
